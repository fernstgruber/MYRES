...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Teresa Mancevski}{Airborne Technologies GmbH \\Viktor Lang Straße 8\\A-2700 Wiener Neustadt}
\date{22. Nov, 2018}
\opening{Sehr geehrte Frau Mancevski,}
\closing{Mit besten Gr\"{u}{\ss}en,}
\enclosure[Anhang]{Lebenslauf und Publikationsliste}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle
\justify
...
\item ReBo -- Reliefklassifizierung aus ALS Daten als Grundlage f\"ur die Regionalisierung von Bodendaten
  ...
  \end{itemize}
\end{itemize}}
\cventry{2016--2017}{Universit\"{a}tsdozent}{Institute of Geography, University of Innsbruck}{Innsbruck}{}{\"{U}bungen zur Statistik mit R (2 Semester)}
\cventry{2016--2017}{Bildungskarenz}{}{}{}{Arbeit an Disseration mit dem Arbeitstitel 'Digital terrain analysis to support field soil survey'}
...
\begin{itemize}%
  \item Kartierung von Naturgefahren, Gletschern und Infrastruktur durch Fernerkundungsmethoden
  \end{itemize}
  \end{itemize}}
...
\begin{itemize}%
  \item Kartierung von Naturgefahren und Gletscherseen anhand von Satellitenbildern 
...
\section{Ausbildung}
\cvitem{2002--2011}{Diplomstudium der Kulturtechnik unc Wasserwirtschaft an der Universit\"{a}t f\"{u}r Bodenkultur (BOKU), Wien}
...
\cvitemwithcomment{Spanish}{Grundkenntnisse}{ }
\cvitemwithcomment{French}{Grundkenntnisse}{ }

\section{EDV-Kenntnisse}
\cvdoubleitem{Operating systems}{Linux (Ubuntu), Windows} {Languages}{R, Python, Bash}
\cvdoubleitem{Geographic information systems}{GRASS, SAGA, QGIS, ARCGIS} {Text- verarbeitung } {MS Word, Libreoffice,  \LaTeX{} with Texmaker}
