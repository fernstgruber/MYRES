...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Hutchison Drei Austria \\z.H. Frau Judith Minelli}{Br\"unner Str. 52\\1210 Wien}
\date{16. Februar 2018}
\opening{\textbf{Betreff: Bewerbung als Geomarketing Manager} \\[0.5cm]     Sehr geehrte Frau Minelli!}
...
Nach mehreren Jahren der T\"atigkeit an Universit\"aten m\"ochte ich nun ein neues Kapitel aufschlagen und mich f\"ur die ausgeschriebene Stelle als Geomarketing Manager bewerben. An der Stelle reizt mich sowohl die M\"oglichkeit, mich weiterhin intensiv mit Geoinformationssystemen zu besch\"aftigen, als auch die Herausforderung, meine Erfahrungen aus der naturwissenschaftlichen Analyse r\"aumlicher Daten in ein neues, komplexes Themenfeld einzubringen.

Die Analyse und Visualisierung r\"aumlicher Daten geh\"ort seit Jahren zu meinen Hauptaufgaben. L \"uber die Jahre hat sich mein Hauptaugenmerk von der reinen Kartenerstellung (mit ArcGIS) weiter in Richtung statistischer Auswertung r\"aumlicher Daten mit einer Kombination verschiedener Open Source Tools (GRASS, SAGA, QGIS, R, Python) gewandelt. So habe ich in meiner Forschungst\"atigkeit an der LFU Innsbruck etwa mit Machine Learning Ans\"atzen (Support Vector Machine-  sowie Random Forest-Klassifikationen) Zusammenhänge in einer gro{\ss}en Menge von Geodaten gesucht und bodelrelevante Informationen modelliert.

Neben meiner Begeisterung für die Analyse r\"aumlicher Daten um Zusammenhänge in komlexen Daten zu entdecken, bringe ich langj\"ahrige Erfahung im selbstst\"andigen Einarbeiten in neue Themengebiete sowie Software.  
