...
\enclosure[Attached]{Resume, list of publications and Diploma Certificate}          % use an optional argument to use a string other than "Enclosure", or redefine \enclname
\makelettertitle
\justify
